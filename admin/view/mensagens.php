...
$mensagens['006'] = "Pergunta Cadastrada com Sucesso!!!";
$mensagens['007'] = "Respostas Cadastradas com Sucesso!!!";
$mensagens['008'] = "Matéria Cadastrada com Sucesso!!!";
if(!$mensagens['006']){
$destino = "../loginAdmin.php";
  
}elseif(($mensagens['006']) ||($mensagens['007']) || ($mensagens['008'])){
